...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_ARQ54 )
{ "ARQ54", { HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL }, { HB_FUNCNAME( ARQ54 ) }, NULL },
{ "SAVESCREEN", { HB_FS_PUBLIC }, { HB_FUNCNAME( SAVESCREEN ) }, NULL },
{ "MAXROW", { HB_FS_PUBLIC }, { HB_FUNCNAME( MAXROW ) }, NULL },
{ "MAXCOL", { HB_FS_PUBLIC }, { HB_FUNCNAME( MAXCOL ) }, NULL },
{ "A54", { HB_FS_PUBLIC | HB_FS_MEMVAR }, { NULL }, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_ARQ54, "", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_ARQ54
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_ARQ54 )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( ARQ54 )
{
	static const HB_BYTE pcode[] =
	{
		...
		58,0,83,7,0,36,6,0,106,7,111,114,99,109,116,111,0,83,8,
		0,25,31,36,8,0,106,3,84,58,0,83,7,0,36,9,0,106,10,
		84,58,92,111,114,99,109,116,111,0,83,8,0,36,11,0,176,9,0,
