...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_ARQ36 )
{ "ARQ36", { HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL }, { HB_FUNCNAME( ARQ36 ) }, NULL },
{ "SAVESCREEN", { HB_FS_PUBLIC }, { HB_FUNCNAME( SAVESCREEN ) }, NULL },
{ "MAXROW", { HB_FS_PUBLIC }, { HB_FUNCNAME( MAXROW ) }, NULL },
{ "MAXCOL", { HB_FS_PUBLIC }, { HB_FUNCNAME( MAXCOL ) }, NULL },
{ "A36", { HB_FS_PUBLIC | HB_FS_MEMVAR }, { NULL }, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_ARQ36, "", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_ARQ36
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_ARQ36 )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( ARQ36 )
{
	static const HB_BYTE pcode[] =
	{
		...
		58,0,83,7,0,36,6,0,106,7,100,101,109,111,118,105,0,83,8,
		0,25,31,36,8,0,106,3,84,58,0,83,7,0,36,9,0,106,10,
		84,58,92,100,101,109,111,118,105,0,83,8,0,36,11,0,176,9,0,
		20,0,36,12,0,176,10,0,9,100,109,8,0,100,9,9,20,6,36,
		13,0,176,11,0,12,0,29,154,0,36,14,0,176,12,0,106,6,71,
		...
		0,176,16,0,20,0,26,244,254,36,24,0,176,17,0,121,121,176,2,
