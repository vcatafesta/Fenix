...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_ARQ64 )
{ "ARQ64", { HB_FS_PUBLIC | HB_FS_FIRST | HB_FS_LOCAL }, { HB_FUNCNAME( ARQ64 ) }, NULL },
{ "SAVESCREEN", { HB_FS_PUBLIC }, { HB_FUNCNAME( SAVESCREEN ) }, NULL },
{ "MAXROW", { HB_FS_PUBLIC }, { HB_FUNCNAME( MAXROW ) }, NULL },
{ "MAXCOL", { HB_FS_PUBLIC }, { HB_FUNCNAME( MAXCOL ) }, NULL },
{ "A64", { HB_FS_PUBLIC | HB_FS_MEMVAR }, { NULL }, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_ARQ64, "", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_ARQ64
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_ARQ64 )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( ARQ64 )
{
	static const HB_BYTE pcode[] =
	{
		...
		58,0,83,7,0,36,6,0,106,7,101,115,116,113,95,99,0,83,8,
		0,25,31,36,8,0,106,3,84,58,0,83,7,0,36,9,0,106,10,
		84,58,92,101,115,116,113,95,99,0,83,8,0,36,11,0,176,9,0,
