...
****************
	ErrorBeep()
	Alert(" ATENÄ«O !!!;;CLIENTE N«O LOCALIZADO ", , "W+/B")
	return nil
...
function mdcanc()
	set bell on
	TONE(200,5)
	ALERT(" OPERAÄ«O CANCELADA PELO USUµRIO ", , "W+/B")
	set bell off	
...
****************
	set bell on
	TONE(200,5)
	ALERT(" DADOS N«O LOCALIZADO;;REDIGITE ! ", , "W+/B")
	set bell off
...
****************
	set bell on
	TONE(200,5)
	ALERT(" N∆o Cadastrado;;REDIGITE ! ", , "W+/B")
	set bell off
...
******************
	set bell on
	TONE(200,5)
	ALERT(" ATENÄ«O !!!;;FUNCIONµRIO N«O LOCALIZADO ", , "W+/B")
	set bell off

function mdfor()
	set bell on
	TONE(200,5)
	ALERT(" ATENÄ«O !!!;;FORNECEDOR N«O LOCALIZADO ", , "W+/B")
	set bell off
...
*******************
	set bell on
	TONE(200,5)
	ALERT(" ATENÄ«O !!!;;NRO.PEDIDO N«O LOCALIZADO ", , "W+/B")
	set bell off
...
**************************
   ...
   if Empty( aPrn )
      ...
      while nPrn != 0
         ...
         @ 09, 14 say " Seleá∆o de impressora                                " color "w+/r"
...
elseif TT = 2
   @ 02,01 say "Digite a Raz∆o Social:"
   @ 03,01 GET RZ PICT "!!!!!!!!!!!!!!!!!!!!"
elseif TT = 3
...
while NMC = spac(15)
   ...
   IF EOF()
      TONE(200,5)
      ALERT(" ATENÄ«O !!!;;REPRESENTANTE N«O LOCALIZADO ", , "W+/B")
       if cdtr = 'X'
          rest scre from tela
       endi
       NMC := spac(15)
